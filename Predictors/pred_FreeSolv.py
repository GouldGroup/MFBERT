...
model = torch.load('../Model/fine_tuned/FreeSolv/pytorch_model.bin', map_location=DEVICE).to(DEVICE)


with open('../Datasets/data_splits/FreeSolv/test.pkl', 'rb') as f:
...
with open(f'{OUTPUT_DIR}FreeSolv_preds_and_fps.pkl', 'wb') as f:
    pickle.dump(data,f)