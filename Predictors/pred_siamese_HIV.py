...
model = torch.load('../Model/fine_tuned/Siamese/HIV/pytorch_model.bin', map_location=DEVICE).to(DEVICE)


with open('../Datasets/data_splits/HIV/test.pkl', 'rb') as f:
...
with open(f'{OUTPUT_DIR}HIV_Siamese_preds_and_fps.pkl', 'wb') as f:
    pickle.dump(data,f)