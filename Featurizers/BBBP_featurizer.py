...
OUTPUT_DIR = '../Fingerprints/BBBP/'
os.makedirs(OUTPUT_DIR, exist_ok=True)

class MFBERT_BBBP_featurizer(torch.nn.Module):
    def __init__(self):
        super(MFBERT_BBBP_featurizer, self).__init__()
        self.l1 = None
...
if __name__ == '__main__':
    ...
    model = torch.load('../Model/fine_tuned/BBBP_featurizer/pytorch_model.bin', map_location=DEVICE).to(DEVICE)
