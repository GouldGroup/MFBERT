...
OUTPUT_DIR = '../Fingerprints/HIV/'
os.makedirs(OUTPUT_DIR, exist_ok=True)

class MFBERT_HIV_featurizer(torch.nn.Module):
    def __init__(self):
        super(MFBERT_HIV_featurizer, self).__init__()
        self.l1 = None
...
if __name__ == '__main__':
    ...
    model = torch.load('../Model/fine_tuned/HIV/pytorch_model.bin', map_location=DEVICE).to(DEVICE)
