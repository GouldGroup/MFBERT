...
OUTPUT_DIR = '../Fingerprints/tox21/'
os.makedirs(OUTPUT_DIR, exist_ok=True)

class MFBERT_tox21_featurizer(torch.nn.Module):
    def __init__(self):
        super(MFBERT_tox21_featurizer, self).__init__()
        self.l1 = None
...
if __name__ == '__main__':
    ...
    model = torch.load('../Model/fine_tuned/tox21/pytorch_model.bin', map_location=DEVICE).to(DEVICE)
